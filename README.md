...
iCloud Contacts desktop app for Windows. Loads [icloud.com/contacts](https://www.icloud.com/contacts) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-contacts://` protocol handler

## Installation

1. Download the latest installer from [Releases](https://github.com/taylorivanoff/icloud-contacts-windows/releases)
